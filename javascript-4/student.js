...
let faveColors = ['Purple', 'Pink', 'Blue']
...
let me = {
    firstname: 'Shokupanman' ,
    superHeroName: 'THE Shokupanman' ,
    homeTown: 'Kouchi' ,
    superPowers: ['the power of bread', 'a delicious move set', 'the ability to spell incorrectly all the timez'] ,
...
//////////////////Step 6////////////////////
//Lastly, create a function called redactInfo that will take in an obj as a paramter. Let's imagine our super hero needs to go undercover and we need to remove all info about them. That is what this function will do. Loop over the object and change each keys value to 'redacted'.
