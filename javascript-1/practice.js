...
let myNumbersIndex = []
myNumbers.forEach((x,i) => myNumbersIndex.push(i))
...
let enemies = people.filter((x,i)  => x.friend === false)
...
// Using the people array above, let's get a total of the awesomeLevel from all the people. Call the new array 'totallyAwesome'. Use .reduce()
 ...
 x = (acc,i) => 37 + i.awesomeLevel ;
let totallyAwesome = people.reduce(x)
